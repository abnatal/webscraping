...
This scripts gets informations about new/used vehicles prices in brazilian market.
"""
class Fipe:
    def __init__(self):
...
if __name__ == '__main__':
    ...
    #print(f.get_tables())
    #print(f.get_brands(table_id=281, vehicle_type=1) )
    #print(f.get_models(table_id=281, vehicle_type=1, brand_id=26))
    #print(f.get_model_years(table_id=281, vehicle_type=1, brand_id=26, model_id=7830))
    #print(f.get_model_price(table_id=281, vehicle_type=1, brand_id=26, model_id=7830, model_year=2017))
